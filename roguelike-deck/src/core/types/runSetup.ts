// ラン開始設定の型定義
// Phase 2: "balanced" | "combo" のみ。Phase 5 で "guardian" | "erosion" を追加予定
export type StartingDeckType = "balanced" | "combo";
...
export interface RunConfig {
  ...
  readonly originalCardId: string | null; // null = 持ち込まない（9枚デッキ）
